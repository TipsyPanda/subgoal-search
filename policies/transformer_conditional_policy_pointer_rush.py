...
from supervised.rush.gen_rush_data import encode_policy_data
...
from supervised.rush import hf_rush_value, hf_rush_policy, gen_rush_data, \
    rush_solver_utils
from supervised.rush.rush_solver_utils import make_RushEnv, cube_to_string, \
    generate_problems_rush
...
class ConditionalPolicyRush:
    def __init__(self,
        ...
        self.tokenizer = hf_rush_policy.RushPolicyTokenizer(
            model_max_length=hf_rush_policy.SEQUENCE_LENGTH,
            padding_side='right',
            pad_token=hf_rush_policy.PADDING_LEXEME
        )
        self.env = make_RushEnv()
        self.model = None
    ...
    def predict_action_str(self, state_target_formula):
        ...
        dataset = GoalDataset.from_state([policy_input], self.tokenizer, max_length=hf_rush_policy.SEQUENCE_LENGTH)
        inputs = [
        ...
        model_outputs = self.model.generate(
            ...
            max_length=hf_rush_value.SEQUENCE_LENGTH,
            # num_beams=1,
            # # num_beam_groups=2,
    ...
    def predict_actions(self, proof_state, subgoal):
        ...
        try:
            ...
            return None
        return rush_solver_utils.decode_action(action_str)
    ...
    def reach_subgoal(self, proof_state, subgoal, debugg_mode=False):
        ...
        self.env.load_state(gen_rush_data.cube_str_to_state(proof_state[1:-1]))
